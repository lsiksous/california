...
#+PROPERTY: header-args:jupyter-python :session *Py* :results raw drawer :cache yes :async yes :exports results :eval yes
...
#+RESULTS[8e472e96bf67cbb9738fc73b8adc00cdb26cc83c]:
:results:
4 - 05b0fd66-373c-45ab-aa93-6ccb10e9ca10
:end:
...
#+RESULTS[20949f2d33b204a38e8e10996556027d946e5f54]:
:results:
3 - 33a38e79-7a54-4836-97d5-1230d50c2a85
:end:
...
gm = GridSearchCV(estimator=rf, param_grid=param_grid, cv=5, n_jobs=6)
%time gm.fit(X, y)
gm.best_params_
#+end_src
